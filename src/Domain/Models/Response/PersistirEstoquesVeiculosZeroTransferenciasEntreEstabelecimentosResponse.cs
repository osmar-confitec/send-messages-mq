...
{
    public class PersistirEstoquesVeiculosZeroTransferenciasEntreEstabelecimentosResponse
    {
        ...
        public PersistirEstoquesVeiculosZeroTransferenciasEntreEstabelecimentosResponse()
        {
